package com.moura.workshopmongo.config;
...
import com.moura.workshopmongo.dto.AuthorDTO;
import com.moura.workshopmongo.dto.CommentDTO;
import com.moura.workshopmongo.repository.PostRepository;
import com.moura.workshopmongo.repository.UserRepository;
...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		CommentDTO c2 = new CommentDTO("Aproveite", sdf.parse("2/03/2018"), new AuthorDTO(bob));
